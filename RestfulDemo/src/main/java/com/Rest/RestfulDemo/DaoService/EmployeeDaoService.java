package com.Rest.RestfulDemo.DaoService;

import com.Rest.RestfulDemo.Extras.HelloWorldBean;
...
public class EmployeeDaoService {
    ...
    static {
        emp.add(new Employee(1, "Pinki", 23));
        emp.add(new Employee(2, "Parineeta", 24));
